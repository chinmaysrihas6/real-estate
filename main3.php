...
<html lang="en" class="h-full">
 ...
 <body class="h-full font-body">
  <div id="app" class="h-full overflow-auto" style="background: linear-gradient(180deg, #1a1f2e 0%, #2a3447 50%, #374156 100%);"><!-- Header -->
   <header class="sticky top-0 z-50 backdrop-blur-md bg-slate-900/90 border-b border-amber-400/40 shadow-2xl">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
     <div class="flex items-center justify-between h-16 sm:h-20">
      <div class="flex items-center gap-3">
       ...
       <div>
        <h1 id="company-name" class="font-display text-lg sm:text-xl font-bold text-amber-50">Crown Estates</h1>
        <p class="text-xs text-amber-200 hidden sm:block">Premium Property Holdings</p>
       </div>
      </div>
      ...
      <nav class="hidden md:flex items-center gap-8"><button onclick="showDashboard()" class="nav-item text-gray-100 hover:text-amber-200 py-2 transition-colors active" id="nav-dashboard">Dashboard</button> <button onclick="showAllProperties()" class="nav-item text-gray-100 hover:text-amber-200 py-2 transition-colors" id="nav-properties">All Properties</button>
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-slate-900/98 border-t border-amber-400/40">
     <div class="px-4 py-3 space-y-2"><button onclick="showDashboard(); toggleMobileMenu();" class="block w-full text-left px-3 py-2 text-gray-100 hover:text-amber-200 hover:bg-slate-800/50 rounded-lg">Dashboard</button> <button onclick="showAllProperties(); toggleMobileMenu();" class="block w-full text-left px-3 py-2 text-gray-100 hover:text-amber-200 hover:bg-slate-800/50 rounded-lg">All Properties</button>
     </div>
    </div>
   </header><!-- Main Content -->
   <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8"><!-- Dashboard View -->
    <div id="dashboard-view"><!-- Title Section -->
     <div class="text-center mb-10 fade-in">
      <h2 id="dashboard-title" class="font-display text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-3" style="text-shadow: 0 0 30px rgba(212, 175, 55, 0.3);">Portfolio Dashboard</h2>
      <p class="text-amber-100 text-lg">Manage and explore premium real estate investments</p>
      <div class="w-24 h-1 gradient-gold mx-auto mt-4 rounded-full shadow-lg" style="box-shadow: 0 0 20px rgba(212, 175, 55, 0.5);"></div>
     </div><!-- Stats Overview -->
     <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
      <div class="bg-slate-800/70 rounded-xl p-4 sm:p-6 border border-amber-400/40 card-hover shadow-2xl" style="box-shadow: 0 10px 40px rgba(0,0,0,0.3), 0 0 20px rgba(212,175,55,0.1);">
       <div class="flex items-center gap-3 mb-2">
        <div class="w-10 h-10 bg-amber-500/30 rounded-lg flex items-center justify-center shadow-lg">
         <svg class="w-5 h-5 text-amber-300" fill="currentColor" viewbox="0 0 24 24">
          <path d="M12 7V3H2v18h20V7H12zM6 19H4v-2h2v2zm0-4H4v-2h2v2zm0-4H4V9h2v2zm0-4H4V5h2v2zm4 12H8v-2h2v2zm0-4H8v-2h2v2zm0-4H8V9h2v2zm0-4H8V5h2v2zm10 12h-8v-2h2v-2h-2v-2h2v-2h-2V9h8v10zm-2-8h-2v2h2v-2zm0 4h-2v2h2v-2z" />
         </svg>
        </div><span class="text-gray-200 text-sm">Total Properties</span>
       </div>
       <p class="text-2xl sm:text-3xl font-display font-bold text-white">24</p>
      </div>
      <div class="bg-slate-800/70 rounded-xl p-4 sm:p-6 border border-emerald-400/40 card-hover shadow-2xl" style="box-shadow: 0 10px 40px rgba(0,0,0,0.3), 0 0 20px rgba(16,185,129,0.1);">
       <div class="flex items-center gap-3 mb-2">
        <div class="w-10 h-10 bg-emerald-500/30 rounded-lg flex items-center justify-center shadow-lg">
        ...
        </div><span class="text-gray-200 text-sm">Total Value</span>
       </div>
       <p class="text-2xl sm:text-3xl font-display font-bold text-emerald-300">$48.5M</p>
      </div>
      <div class="bg-slate-800/70 rounded-xl p-4 sm:p-6 border border-blue-400/40 card-hover shadow-2xl" style="box-shadow: 0 10px 40px rgba(0,0,0,0.3), 0 0 20px rgba(59,130,246,0.1);">
       <div class="flex items-center gap-3 mb-2">
        <div class="w-10 h-10 bg-blue-500/30 rounded-lg flex items-center justify-center shadow-lg">
        ...
        </div><span class="text-gray-200 text-sm">Holders</span>
       </div>
       <p class="text-2xl sm:text-3xl font-display font-bold text-white">4</p>
      </div>
      <div class="bg-slate-800/70 rounded-xl p-4 sm:p-6 border border-purple-400/40 card-hover shadow-2xl" style="box-shadow: 0 10px 40px rgba(0,0,0,0.3), 0 0 20px rgba(168,85,247,0.1);">
       <div class="flex items-center gap-3 mb-2">
        <div class="w-10 h-10 bg-purple-500/30 rounded-lg flex items-center justify-center shadow-lg">
         <svg class="w-5 h-5 text-purple-300" fill="currentColor" viewbox="0 0 24 24">
          <path d="M16 6l2.29 2.29-4.88 4.88-4-4L2 16.59 3.41 18l6-6 4 4 6.3-6.29L22 12V6z" />
         </svg>
        </div><span class="text-gray-200 text-sm">Avg. ROI</span>
       </div>
       <p class="text-2xl sm:text-3xl font-display font-bold text-purple-300">12.4%</p>
      </div>
     </div><!-- Two Column Layout -->
     <div class="grid lg:grid-cols-2 gap-8"><!-- Property Holders Section -->
      <div class="bg-slate-800/60 rounded-2xl p-6 border border-amber-400/40 slide-in shadow-2xl" style="box-shadow: 0 10px 40px rgba(0,0,0,0.3), 0 0 20px rgba(212,175,55,0.15);">
       <div class="flex items-center gap-3 mb-6">
        ...
        <div>
         <h3 class="font-display text-xl font-bold text-white">Property Holders</h3>
         <p class="text-amber-100 text-sm">Click to view portfolio</p>
        </div>
       </div>
       <div class="space-y-3" id="holders-list"><!-- Holder cards rendered by JS -->
       </div>
      </div><!-- Property Categories Section -->
      <div class="bg-slate-800/60 rounded-2xl p-6 border border-amber-400/40 slide-in shadow-2xl" style="animation-delay: 0.2s; box-shadow: 0 10px 40px rgba(0,0,0,0.3), 0 0 20px rgba(212,175,55,0.15);">
       <div class="flex items-center gap-3 mb-6">
        <div class="w-12 h-12 gradient-gold rounded-xl flex items-center justify-center shadow-lg">
         <svg class="w-6 h-6 text-gray-900" fill="currentColor" viewbox="0 0 24 24">
        ...
        <div>
         <h3 class="font-display text-xl font-bold text-white">Property Categories</h3>
         <p class="text-amber-100 text-sm">Browse by type</p>
        </div>
       </div>
    ...
    <div id="properties-view" class="hidden">
     <div class="mb-8"><button onclick="showDashboard()" class="flex items-center gap-2 text-amber-200 hover:text-amber-100 transition-colors mb-4">
       <svg class="w-5 h-5" fill="none" stroke="currentColor" viewbox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
       </svg> Back to Dashboard </button>
      <h2 id="view-title" class="font-display text-3xl sm:text-4xl font-bold text-white mb-2" style="text-shadow: 0 0 30px rgba(212, 175, 55, 0.3);"></h2>
      <p id="view-subtitle" class="text-amber-100"></p>
      <div class="w-20 h-1 gradient-gold mt-4 rounded-full shadow-lg" style="box-shadow: 0 0 20px rgba(212, 175, 55, 0.5);"></div>
     </div><!-- Filter Buttons -->
   ...
   <footer class="border-t border-amber-400/40 mt-12 bg-slate-900/70 shadow-2xl" style="box-shadow: 0 -10px 40px rgba(0,0,0,0.3);">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
     <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
      <div class="flex items-center gap-3">
       <div class="w-8 h-8 gradient-gold rounded-lg flex items-center justify-center shadow-lg">
        <svg class="w-4 h-4 text-gray-900" fill="currentColor" viewbox="0 0 24 24">
         <path d="M12 3L4 9v12h16V9l-8-6z" />
        </svg>
       </div><span class="font-display text-white font-semibold">Crown Estates</span>
      </div>
      <p class="text-gray-300 text-sm">© 2024 Premium Property Holdings. All rights reserved.</p>
     </div>
    </div>
   </footer>
  </div>
  <script>
    ...
    function renderHolders() {
      ...
      container.innerHTML = holders.map((holder, index) => `
        <button onclick="showHolderProperties(${holder.id})" 
                class="w-full flex items-center gap-4 p-4 bg-slate-700/50 hover:bg-slate-700/70 rounded-xl border border-slate-600/50 hover:border-amber-400/70 transition-all duration-300 card-hover group"
                style="animation-delay: ${index * 0.1}s; box-shadow: 0 4px 15px rgba(0,0,0,0.2);">
          <div class="w-12 h-12 bg-gradient-to-br ${holder.color} rounded-xl flex items-center justify-center font-display font-bold text-white text-lg shadow-xl">
            ${holder.avatar}
          </div>
          <div class="flex-1 text-left">
            <h4 class="font-display font-semibold text-white group-hover:text-amber-200 transition-colors">${holder.name}</h4>
            <p class="text-gray-200 text-sm">${holder.properties} properties • ${holder.totalValue}</p>
          </div>
          <svg class="w-5 h-5 text-amber-300 group-hover:text-amber-200 group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    function renderPropertyCard(property) {
      const statusColors = {
        'Available': 'bg-emerald-500/30 text-emerald-200 border-emerald-400/70 shadow-lg',
        'Occupied': 'bg-blue-500/30 text-blue-200 border-blue-400/70 shadow-lg',
        'Development': 'bg-amber-500/30 text-amber-200 border-amber-400/70 shadow-lg',
        'Leased': 'bg-purple-500/30 text-purple-200 border-purple-400/70 shadow-lg'
      };
      
      return `
        <div class="bg-slate-800/60 rounded-xl overflow-hidden border border-slate-700/60 card-hover fade-in shadow-2xl" style="box-shadow: 0 10px 30px rgba(0,0,0,0.3);">
          <div class="h-40 bg-gradient-to-br from-slate-700/70 to-slate-800/90 flex items-center justify-center text-6xl">
            ${property.image}
          </div>
          <div class="p-5">
            <div class="flex items-start justify-between mb-3">
              <span class="px-2 py-1 text-xs font-semibold rounded-full bg-amber-500/30 text-amber-200 border border-amber-400/60 shadow-lg">${property.type}</span>
              <span class="px-2 py-1 text-xs font-semibold rounded-full border ${statusColors[property.status]}">${property.status}</span>
            </div>
            <h4 class="font-display font-bold text-white text-lg mb-2">${property.name}</h4>
            <p class="text-gray-200 text-sm flex items-center gap-1 mb-4">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
              ${property.location}
            </p>
            <div class="flex items-center justify-between pt-4 border-t border-slate-600/60">
              <div>
                <p class="text-xs text-gray-300">Value</p>
                <p class="font-display font-bold text-emerald-300 text-lg">${property.value}</p>
              </div>
              <div class="text-right">
                <p class="text-xs text-gray-300">Area</p>
                <p class="text-white font-semibold">${property.area}</p>
              </div>
            </div>
          </div>
        </div>
 ...
 <script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'9c1f5120544f3b19',t:'MTc2OTA4NzY5My4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>